    ...
    <main className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-6 font-sans antialiased">
      ...
      <div className="w-full max-w-[340px]">
        ...
        <div className="mb-12 text-center">
          <h1 className="text-5xl font-bold uppercase tracking-tighter mb-2">Создать</h1>
          <p className="text-[10px] text-zinc-600 uppercase tracking-widest">Новое пространство данных</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-10">
          ...
          <div className="space-y-2">
            <label className="text-[9px] font-black uppercase tracking-[0.3em] text-zinc-700">Workspace Name</label>
            <div className="relative flex items-center border-b border-white/10 focus-within:border-white transition-all">
              <input
                required
                placeholder="MY-COMPANY"
                className="w-full bg-transparent py-3 text-sm font-bold uppercase tracking-widest outline-none placeholder:text-zinc-900"
                onChange={(e) => setForm({ ...form, tenant_slug: e.target.value })}
              />
              <span className="text-[9px] font-bold text-zinc-800 uppercase tracking-widest">.sledix.tech</span>
            </div>
          </div>

          {/* Email Address */}
          <div className="space-y-2">
            <label className="text-[9px] font-black uppercase tracking-[0.3em] text-zinc-700">Your Email</label>
            <input
              required
              type="email"
          ...
          <div className="pt-2 space-y-6">
            ...
            >
              {loading ? "РЕГИСТРАЦИЯ..." : "Создать аккаунт"} <ArrowUpRight size={14} />
            </button>

            {/* Legal Consent */}
            <p className="text-[8px] font-bold text-zinc-800 uppercase tracking-[0.2em] text-center leading-relaxed">
              Создавая аккаунт, вы соглашаетесь с <br />
              <Link href="/legal/terms" className="text-zinc-600 hover:text-white underline underline-offset-2 transition-colors">Условиями обслуживания</Link> и <br />
              <Link href="/legal/privacy" className="text-zinc-600 hover:text-white underline underline-offset-2 transition-colors">Политикой конфиденциальности</Link>
            </p>

            <div className="flex flex-col items-center pt-4">
              <Link href="/auth/login" className="text-[9px] font-bold uppercase tracking-widest text-zinc-600 hover:text-white transition-all">
      ...
      <div className="mt-20">
        <span className="text-[8px] font-bold uppercase tracking-[0.6em] text-zinc-900">
          SLEDIX 2026. All rights received.
        </span>
      </div>
