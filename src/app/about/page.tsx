      ...
      <section className="relative z-10 py-24 px-8 md:px-14 max-w-[1200px] mx-auto border-t border-white/[0.06]">
        <div className="flex flex-col md:flex-row gap-16 items-start">
          ...
          <div className="md:w-2/3 grid grid-cols-1 sm:grid-cols-2 gap-8" style={{ animation: "fadeUp 0.8s cubic-bezier(.16,1,.3,1) both 0.2s" }}>
            <div className="group rounded-2xl border border-white/[0.08] bg-white/[0.02] p-4 transition-all duration-500 hover:border-white/20 hover:bg-white/[0.035]">
              <div className="relative aspect-[4/5] bg-white/[0.03] border border-white/[0.08] rounded-xl mb-4 overflow-hidden grayscale transition-all duration-500 group-hover:grayscale-0">
                <div
                  className="absolute -top-20 left-1/2 -translate-x-1/2 w-56 h-56 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-700"
                  style={{ background: "radial-gradient(circle, rgba(255,255,255,0.16) 0%, rgba(255,255,255,0) 65%)" }}
                />
                <div className="relative w-full h-full flex flex-col items-center justify-center gap-3 text-white">
                  <div className="w-14 h-14 rounded-full border border-white/20 bg-white/[0.04] flex items-center justify-center font-mono text-sm tracking-widest">
                    NS
                  </div>
                  <div className="font-mono text-[10px] uppercase tracking-[0.2em] text-white/65">Founder / CTO</div>
                </div>
              </div>
              <div className="flex items-center justify-between gap-3 mb-1">
                <h4 className="font-bold text-lg">Сороколетов Николай Артемович</h4>
                <span className="text-[9px] font-mono uppercase tracking-[0.2em] text-white/45 border border-white/15 rounded-full px-2.5 py-1">
                  Tech
                </span>
              </div>
            ...
            <div className="group rounded-2xl border border-white/[0.08] bg-white/[0.02] p-4 transition-all duration-500 hover:border-white/20 hover:bg-white/[0.035]">
              <div className="relative aspect-[4/5] bg-white/[0.03] border border-white/[0.08] rounded-xl mb-4 overflow-hidden grayscale transition-all duration-500 group-hover:grayscale-0">
                ...
                <div className="relative w-full h-full flex flex-col items-center justify-center gap-3 text-white">
                  ...
                  <div className="font-mono text-[10px] uppercase tracking-[0.2em] text-white/65">Product / Marketing</div>
                </div>
              </div>
              <div className="flex items-center justify-between gap-3 mb-1">
                <h4 className="font-bold text-lg">Кочетков Никита</h4>
                <span className="text-[9px] font-mono uppercase tracking-[0.2em] text-white/45 border border-white/15 rounded-full px-2.5 py-1">
                  Product
                </span>
              </div>
